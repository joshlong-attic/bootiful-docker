...
:todo:
:bootiful-docker: bootiful-docker
...
There are many ways to build portable, reproducible applications. Spring natively supports the 12-factor app style recommendations  like those for [backing services](https://spring.io/blog/2015/01/27/12-factor-app-style-backing-services-with-spring-and-cloud-foundry) and [externalized configuration](https://spring.io/blog/2015/01/13/configuring-it-all-out-or-12-factor-app-style-configuration-with-spring).
